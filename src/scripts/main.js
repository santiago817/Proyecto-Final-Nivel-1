...
import { filterStays } from "./filtro.js";
...
multiHeader();
document.addEventListener("DOMContentLoaded", () => autoStayCounter());


document.getElementById("filterBtn")?.addEventListener("click", filterStays);
document.getElementById("filterBtnPC")?.addEventListener("click", filterStays);
