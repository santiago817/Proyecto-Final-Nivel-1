...
stays.forEach((stay) => {
  ...
  <div class="flex items-center gap-3 mt-2 text-sm">
    ...
    ${stay.beds ? `<span class="text-gray-500">· ${stay.beds} beds</span>` : ""}
    <div class="flex items-center gap-1 ml-auto">
      <svg class="w-4 h-4 text-[#eb5757]" fill="currentColor" viewBox="0 0 20 20">
        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.2 3.692h3.884c.969 0 1.371 1.24.588 1.81l-3.145 2.285 
                 1.2 3.692c.3.921-.755 1.688-1.54 1.118L10 13.347l-3.138 2.177c-.785.57-1.84-.197-1.54-1.118l1.2-3.692
                 -3.145-2.285c-.783-.57-.38-1.81.588-1.81h3.884l1.2-3.692z"/>
      </svg>
...
import { multiHeader } from "./header.js";
...
import { autoStayCounter } from "./contador.js";
